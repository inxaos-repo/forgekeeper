...
public interface IModelRepository
{
    ...
    Task<(List<Model3D> Items, int TotalCount)> GetByCreatorIdPagedAsync(Guid creatorId, int page = 1, int pageSize = 50, string? sortBy = null, bool sortDescending = false, CancellationToken ct = default);
